...
<head>
    ...
    <title>New Registration - CovDango</title>
    ...
    <section id="main_content">
        <div class="cards_container container">
            <div class="overview_card">
                ...
                <h1 class="overview_heading"><span>Update</span> Details</h1>
                    ...
                    <div class="overview_info">
                        <div class="small-8">
                            ...
                            <div class="row">
                                ...
                                <div class="small-8 columns">
                                <input type="text" id="right-label" placeholder="Address" name="addressx">
                                </div>
                                <br>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="small-8 columns">
                                <input type="number" id="right-label" placeholder="Postal Code" name="postcode">
                                </div>
                                <br>
                            </div>
                            <div class="row">
                                <div class="small-4 columns">
                                <label for="right-label" class="right inline">Old E-Mail</label>
                                </div>
                                <div class="small-8 columns">
                                <input type="email" id="right-label" placeholder="Old E-Mail" name="email">
                                </div>
                                <br>
                            </div>
                            <div class="row">
                                <div class="small-4 columns">
                                <label for="right-label" class="right inline">New E-Mail</label>
                                </div>
                                <div class="small-8 columns">
                                <input type="email" id="right-label" placeholder="New E-Mail" name="nemail">
                                </div>
                                <br>
                            </div>
                            <div class="row">
                                <div class="small-4 columns">
                                <label for="right-label" class="right inline">Old Password</label>
                                </div>
                                <div class="small-8 columns">
                            ...
                            <div class="row">
                                <div class="small-8 columns">
                                <input type="submit" id="right-label" value="Submit" style="background: #310A31; border: none; color: #fff; font-family: 'Montserrat', sans-serif; font-size: 1em; padding: 10px;">
                                <input type="reset" id="right-label" value="Reset" style="background: #310A31; border: none; color: #fff; font-family: 'Montserrat', sans-serif; font-size: 1em; padding: 10px;">
                                </div>
                                <br>
                            </div>
                        </div>
