    ...
    <section id="main_content">
        <div class="cards_container container">
            <div class="overview_card">
                <div id="center">
                    <h1 class="overview_heading"> You Have Tested <span><element id="gr">Negative</element></span> for COVID-19</h1>
                    <img src="./images/test_negative.png" class="result_img">
                    <br><br>
                    <p class="overview_info">
                        <h3 class="total_confirmed_heading">
                            Please continue to practice safe health protocols and beware of close contacts.
                        </h3>
                    </p>
                    <br><br>
