    ...
    <section id="main_content">
        <div class="cards_container container">
            <div class="overview_card">
                ...
                <h1 class="overview_heading">Register User</h1>
                <form method="POST" action="insert.php" style="margin-top:30px;">
                    <div class="overview_info">
                        <div class="small-8">
                            ...
                            <div class="row">
                                <div class="small-8 columns">
                                <input type="submit" id="right-label" value="Register" style="background: #310A31; border: none; color: #fff; font-family: 'Montserrat', sans-serif; font-size: 1em; padding: 10px;">
