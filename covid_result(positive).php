...
<head>
    ...
    <title>Diagnosis Result - CovDango</title>
    ...
    <section id="main_content">
        <div class="cards_container container">
            <div class="overview_card">
                <div id="center">
                    <h1 class="overview_heading"> You Have Tested <span>Positive</span> for COVID-19</h1>
                    <img src="./images/test_positive.png" class="result_img">
                    <br><br>
                    <p class="overview_info">
                        <h3 class="total_confirmed_heading">
                            For you and everyone's safety,
                            please follow proper COVID-19 protocol and practice self-quarantine procedure.
                        </h3>
                    </p>
                    <br><br>
