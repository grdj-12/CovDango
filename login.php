    ...
    <section id="main_content">
        <div class="cards_container container">
            <div class="overview_card">
                ...
                <h1 class="overview_heading">Login</h1>
                <form method="POST" action="verify.php" style="margin-top:30px;">
                    <div class="overview_info">
                        <div class="small-8">
                            ...
                            <div class="row">
                                <div class="small-8 columns">
                                <input type="submit" id="right-label" value="Login" style="background: #310A31; border: none; color: #fff; font-family: 'Montserrat', sans-serif; font-size: 1em; padding: 10px;">
